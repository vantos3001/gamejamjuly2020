...
public class MovingObjectRenderer : MonoBehaviour
{
    public static readonly string[] staticDirections = { "left", "right" };
    public static readonly string[] runDirections = {"left", "right"};
